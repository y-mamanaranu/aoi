...
| guild_id   |                                     |         |
| member_id  |                                     |         |
| last_join  | When user joined vocie channel last | 0       |
| last_leave | When user left vocie channel last   | 0       |
| total      | How long user joined vocie channel  | 0       |
...
| --------------------- | ------------------------------------------------------------------------------------------------ | ------------------------------------------------ | ------- | --------------- |
| on_raw_reaction_add   | When @Senior adds :emoji: to a message in #Profile, the author of the message receives @Freshman | Any of @Freshman, @Senior and #Profile is `None` | disable | level_to_assign |
|                       | Increase level by how long member join the voice channel                                         | level? is `False`                                | disable | implement       |
